              ...
              <form method="POST" action="/guru/update/{{ $guru->id }}">
                ...
                <table width="50%">
                    ...
                    <tr>
                        ...
                        <td width="25%"><input type="radio" name="jk" value="L "{{ $guru->jk == 'L' ? 'checked' : '' }}>Laki-laki</td>
                        <td width="25%"><input type="radio" name="jk" value="P "{{ $guru->jk == 'P' ? 'checked' : '' }}>Perempuan</td>                
                    </tr>
                    <tr>
